    ...
    <main className="max-w-4xl mx-auto px-6 py-16">
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
        ...
        <Section title="1. Acceptance of Terms">
          By accessing or using occultusHub (the "Site"), you agree to be bound by these Terms of
          Service. If you do not agree, please do not use the Site. These terms apply to all
          visitors, members, and any other users of the Site.
        </Section>

        <Section title="2. Eligibility">
          The Site is intended solely for members of the Occultus faction network on the
        ...
        <Section title="4. Permitted Use">
          The Site is provided for informational and community purposes within the Occultus
          ...
          <ul style={{ paddingLeft: '24px', marginTop: '12px', display: 'flex', flexDirection: 'column', gap: '6px' }}>
            ...
            <li>Scrape, harvest, or automate requests to the Site in a manner that disrupts normal operation</li>
            <li>Reverse-engineer, decompile, or otherwise attempt to extract source code</li>
            <li>Use the Site for any purpose that violates Torn's own Terms of Service</li>
            <li>Impersonate another member or misrepresent your identity</li>
          </ul>
        </Section>

        <Section title="5. Content & Accuracy">
          Faction, company, and member data displayed on the Site is sourced from the Torn public
          API and is cached periodically. We do not guarantee that all data is current, complete,
          or error-free. You agree not to rely solely on information from this Site for
          time-sensitive in-game decisions.
        </Section>

        <Section title="6. Intellectual Property">
          All original content, design elements, and code of this Site are the property of the
          Occultus faction administration. Torn game data and trademarks remain the property of
          Torn Ltd. The occultusHub name, logo, and branding may not be reused without written
          permission.
        </Section>
