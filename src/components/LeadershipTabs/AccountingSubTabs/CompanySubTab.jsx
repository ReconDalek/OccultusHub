...
// Self-contained: own fetch, own card. Moved here (below the main profit
// table, not merged into it) from the Accounting Overview tab per request. ──

function CompanyStockCard() {
